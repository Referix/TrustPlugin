...
public interface DatabaseProvider {
    void connect();
    void close();
    void createTable(DatabaseTable table,TableCreateCallback callback);
    ...
    <T> void searchSinhronizeData(DatabaseTable table, String condition, Class<T> clazz, Consumer<List<T>> callback);
